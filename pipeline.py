...
ACCOUNTS_START = {
    # 3,342,548원은 8/31 마감 잔액이다. 기준일을 8-31로 두어야 9/1 거래
    # (의류 2건 150,900원 + 이체 3건 1,425,000원)가 잔고에서 차감된다.
    "생활비 통장":   {"balance": 3342548, "as_of": "2026-08-31", "desc": "유동 지출 (카드값·경조사·기타)"},
    "신한은행 통장": {"balance": 525000,  "as_of": "2026-09-01", "desc": "매달 고정비 선입금 (통신비·보험비 등)"},
    ...
    "커플통장":     {"balance": 800000,  "as_of": "2026-09-01", "desc": "커플통장 (매달 1일 생활비에서 40만원 이체 · 데이트비 정산)"},
}
